...
<div class="px-4 px-lg-0">
  ...
  <div class="container text-white py-5 text-center">
    <h1 class="display-4">Thanks for choosing <span>MN Wardrobe</span></h1>
    <p id="extra" class="lead mb-0">Finest Stiching ever </p>
    <p id="extra" class="lead">by <a class="lead" href="https://bootstrapious.com/snippets" class=" font-italic">
            <u>Mahnoor Nawaz</u></a>
    </p>
  </div>
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  <th scope="row">
                    <div class="p-2">
                      <img src="https://res.cloudinary.com/mhmd/image/upload/v1556670479/product-2_qxjis2.jpg" alt="" width="70" class="img-fluid rounded shadow-sm"></img>
                      <div class="ml-3 d-inline-block align-middle">
